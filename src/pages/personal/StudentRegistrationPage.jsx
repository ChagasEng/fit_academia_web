  ...
  return <main className="dashboard-page registration-page">
    ...
    <section className="registration-content">
      ...
      <form className="student-form" onSubmit={handleSubmit}>
        ...
        <div className="form-grid"><Field label="Nome completo" value={form.nome} onChange={(value) => setForm({ ...form, nome: value })} required /><Field label="E-mail" type="email" value={form.email} onChange={(value) => setForm({ ...form, email: value })} /><Field label="Telefone" value={form.telefone} onChange={(value) => setForm({ ...form, telefone: value })} required /></div>
        <h2>Endereço</h2>
