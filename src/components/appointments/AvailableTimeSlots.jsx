export default function AvailableTimeSlots({ slots, value, onChange, loading, workingHours, durationMinutes = 60 }) {
  return (
    <section className="available-times" aria-busy={loading}>
      <div className="available-times-heading">
        ...
        <small>Duração de {durationMinutes >= 60 ? `${durationMinutes / 60}h` : `${durationMinutes} min`}</small>
      </div>
